          ...
          @endif
			...
			<div class="panel panel-inverse mt-4">
				...
				<div class="panel-heading bg-blue-700 text-white">
                    <h4 class="panel-title">Data Pengajuan Surat Domisili</h4>
				...
				<div class="panel-body">
					<table id="data-table-default" class="table table-striped table-bordered align-middle">
						...
						<tbody>
							@foreach ($data_domisili as $domisili)
          						<tr>
									<td>{{$domisili->nik}}</td>
									<td>{{$domisili->nama}}</td>
									...
									<td class="text-center">
										<a href="/domisili/{{$domisili->id}}/edit" class="btn btn-primary btn-circle"><i class="fas fa-info-circle"></i></a>
										@if(auth()->user()->role=='Administrator')
										<a href="/domisili/{{$domisili->id}}/cetakPdf" target="blank" class="btn btn-warning btn-circle"><i class="fas fa-download"></i></a>
										<a href="/domisili/{{$domisili->id}}/delete" class="btn btn-danger btn-circle" onclick="return confirm('Yakin menghapus data?')" ><i class="fas fa-trash"></i></a>
										@endif
									</td>
							</tr>
							@endforeach
