...
<html>
<head>
	<title>Surat Keterangan Kelahiran {{$kelahiran->nama}}</title>
	<style type="text/css">
		table {
			border-style: double;
			border-width: 3px;
...
<body>
	<center>
			...
			<tr>
		       <td>
                <center>
                    ...
                    <font size="2"> <b>Nomor: {{$kelahiran->no_surat}}</b> </font><br>
				</center>
		       </td>
		    </tr>
		</table>
		...
		<table width="450">
			<tr class="text2">
				<td>Nama</td>
				<td width="550">: {{$kelahiran->nama_anak}}</td>
			</tr>
			<tr>
				<td>Tempat Lahir</td>
				<td width="525">: {{$kelahiran->tempat_lahir}}</td>
			</tr>
            <tr>
				<td>Tanggal Lahir</td>
				<td width="525">: {{$kelahiran->tgl_lahir_anak}}</td>
			</tr>
			<tr>
				<td>Jenis Kelamin</td>
				<td width="525">: {{$kelahiran->jk_anak}}</td>
			</tr>
            <tr>
				<td width="200"><i>Adalah anak dari</i></td>
			</tr>
            <tr>
				<td>Nama Ayah Kandung</td>
				<td width="525">: {{$kelahiran->nama_suami}}</td>
			</tr>
            <tr>
				<td>Nama Ibu Kandung</td>
				<td width="525">: {{$kelahiran->nama_ibu}}</td>
			</tr>
            <tr>
				<td>Anak ke</td>
				<td width="525">: {{$kelahiran->anak_ke}}</td>
			</tr>
		</table>
		<br>
        <table width="600">
		...
		<table width="625">
			<tr>
				...
				<td class="text" align="center">Karawang, {{$kelahiran->updated_at}}<br>Kepala Desa Karang Anyar<br> <img src="{{ asset('/assets/img/user/paraf.jpg') }}" width="80px"> <br> <b><u>HENRY IRAWAN</u></b></td>
			</tr>
	     </table>
	</center>
</body>
