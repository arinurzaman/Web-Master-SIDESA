          ...
          @endif
			...
			<div class="panel panel-inverse mt-4">
				...
				<div class="panel-heading bg-blue-700 text-white">
                    <h4 class="panel-title">Data Pengajuan Surat Kelahiran</h4>
					...
					<table id="data-table-default" class="table table-striped table-bordered align-middle">
						<thead>
							<tr>
								...
								<th class="text-nowrap">Nama Suami</th>
								<th class="text-nowrap">Alamat</th>
                                <th class="text-nowrap">Tanggal lahir anak</th>
						...
						<tbody>
							@foreach ($data_kelahiran as $kelahiran)
          						<tr>
									...
									<td>{{$kelahiran->nama_suami}}</td>
									<td>{{$kelahiran->alamat_suami}}</td>
									<td>{{$kelahiran->tgl_lahir_anak}}</td>
									<td>{{$kelahiran->status}}</td>
									<td class="text-center">
										<a href="/kelahiran/{{$kelahiran->id}}/edit" class="btn btn-primary btn-circle"><i class="fas fa-info-circle"></i></a>
										@if(auth()->user()->role=='Administrator')
										<a href="/kelahiran/{{$kelahiran->id}}/cetakPdf" target="blank" class="btn btn-warning btn-circle"><i class="fas fa-download"></i></a>
										<a href="/kelahiran/{{$kelahiran->id}}/delete" class="btn btn-danger btn-circle" onclick="return confirm('Yakin menghapus data?')" ><i class="fas fa-trash"></i></a>
										@endif
									</td>
							</tr>
							@endforeach
