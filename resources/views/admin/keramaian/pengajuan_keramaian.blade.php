          ...
          @endif
			...
			<div class="panel panel-inverse mt-4">
				...
				<div class="panel-heading bg-blue-700 text-white">
                    <h4 class="panel-title">Data Pengajuan Surat Keramaian</h4>
				...
				<div class="panel-body">
					<table id="data-table-default" class="table table-striped table-bordered align-middle">
						...
						<tbody>
							@foreach ($data_keramaian as $keramaian)
          						<tr>
									<td>{{$keramaian->nik}}</td>
									<td>{{$keramaian->nama_lengkap}}</td>
									<td>{{$keramaian->kegiatan}}</td>
									<td>{{$keramaian->tgl_keramaian}}</td>
									<td>{{$keramaian->status}}</td>
									<td class="text-center">
										<a href="/keramaian/{{$keramaian->id}}/edit" class="btn btn-primary btn-circle"><i class="fas fa-info-circle"></i></a>
										@if(auth()->user()->role=='Administrator')
										<a href="/keramaian/{{$keramaian->id}}/cetakPdf" target="blank" class="btn btn-warning btn-circle"><i class="fas fa-download"></i></a>
										<a href="/keramaian/{{$keramaian->id}}/delete" class="btn btn-danger btn-circle" onclick="return confirm('Yakin menghapus data?')" ><i class="fas fa-trash"></i></a>
										@endif
									</td>
							</tr>
							@endforeach
