          ...
          @endif
			...
			<div class="panel panel-inverse mt-4">
				...
				<div class="panel-heading bg-blue-700 text-white">
                    <h4 class="panel-title">Data Pengajuan Surat Keterangan Usaha</h4>
							...
							@foreach ($data_sku as $sku)
          						<tr>
									...
									<td class="text-center">
										<a href="/sku/{{$sku->id}}/edit" class="btn btn-primary btn-circle"><i class="fas fa-info-circle"></i></a>
										@if(auth()->user()->role=='Administrator')
										<a href="/sku/{{$sku->id}}/cetakPdf" target="blank" class="btn btn-warning btn-circle"><i class="fas fa-download"></i></a>
										<a href="/sku/{{$sku->id}}/delete" class="btn btn-danger btn-circle" onclick="return confirm('Yakin menghapus data?')" ><i class="fas fa-trash"></i></a>
										@endif
									</td>
							</tr>
							@endforeach
